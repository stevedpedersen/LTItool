...
class At_LTI_ModuleUpgradeHandler extends Bss_ActiveRecord_BaseModuleUpgradeHandler
{
    public function onModuleUpgrade ($fromVersion)
    {
        switch ($fromVersion)
        {
            case 0:
                ...
                $def->addProperty('id', 'string', array('primaryKey' => true, 'sequence' => true));
    ...
    private function getDeploymentData ($registrations)
    {
        return [
            [
                ...
                "registration_id" => "https://spedersen18.dev.at.sfsu.edu/ltitool",
                "customer_id" => "",
                "service" => "https://spedersen18.dev.at.sfsu.edu/ltitool",
            ],
            [
                "id" => "1",
                "registration_id" => "https://spedersen18.dev.at.sfsu.edu/ilearn39",
                "customer_id" => "",
                "service" => "https://spedersen18.dev.at.sfsu.edu/ilearn39",
            ],
            [
                "id" => "209:0b1c0dce1ebe70f1871f52b029433b0569eaf2ea",
                "registration_id" => "https://sfsu.beta.instructure.com",
                "customer_id" => "",
    ...
    private function getRegistrationData ()
    {
        return [
            [
                "id" => "https://spedersen18.dev.at.sfsu.edu/ltitool",
...
-----END RSA PRIVATE KEY-----",
            ...
            [
                "id" => "https://spedersen18.dev.at.sfsu.edu/ilearn39",
...
-----END RSA PRIVATE KEY-----",
            ...
            [
                "id" => "https://sfsu.beta.instructure.com",
