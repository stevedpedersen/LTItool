...
var refreshScoreBoard = function() {
    ...
    for (var i = 0; i < scoreboard.length; i++) {
        output += '<tr><td>' + scoreboard[i].score + '</td><td>' + scoreboard[i].time + 's</td><td>' + scoreboard[i].name + '</td></tr>';
    }
...
var submitScore = function() {
    ...
    // xhttp.open("POST", "api/score", false);
    // xhttp.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded');
    // xhttp.send("launch_id=" + launch_id + "&score=" + window.score + "&time=" + time_taken);

    xhttp.open("GET", "api/score?launch_id=" + launch_id + "&score=" + window.score + "&time=" + time_taken, false);
    xhttp.send();
}
...
var getScoreBoard = function() {
    ...
    xhttp.open("GET", "api/scoreboard?launch_id=" + launch_id, true);
    xhttp.send();
}
