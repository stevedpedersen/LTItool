 ...
 */
class LTITool_AuthN_AccountExtension extends Bss_AuthN_AccountExtension implements Bss_AuthN_IAccountSettingsExtension
{
    ...
    {
        return [
            'roles' => ['N:M', 'to' => 'LTITool_AuthN_Role', 'via' => 'ltitool_authn_account_roles', 'fromPrefix' => 'account', 'toPrefix' => 'role'],
        ];
    }
    ...
    {
        $roles = $handler->schema('LTITool_AuthN_Role');
